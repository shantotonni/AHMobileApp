                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped dt-responsive nowrap dataTable no-footer dtr-inline table-sm small">
                                        ...
                                        <tr v-for="(product, i) in products" :key="product.ID" v-if="products.length">
                                            ...
                                            <td class="text-center">
                                                <button @click="edit(product)" class="btn btn-success btn-sm"><i class="far fa-edit"></i></button>
                                                <button hidden="hidden" @click="destroy(product.ID)" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                ...
                <div class="modal-content">
                    ...
                    <form @submit.prevent="editMode ? update() : store()" @keydown="form.onKeydown($event)" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="Name" v-model="form.ProductName" class="form-control" :class="{ 'is-invalid': form.errors.has('ProductName') }">
                                            <div class="error" v-if="form.errors.has('ProductName')" v-html="form.errors.get('ProductName')" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="Attribute" v-model="form.ProductAttribute" class="form-control" :class="{ 'is-invalid': form.errors.has('ProductAttribute') }">
                                            <div class="error" v-if="form.errors.has('ProductAttribute')" v-html="form.errors.get('ProductAttribute')" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Details</label>
                                            <input type="text" name="Details" v-model="form.Details" class="form-control" :class="{ 'is-invalid': form.errors.has('Details') }">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Image</label>
                                            <input @change="changeImage($event)" type="file" name="ProductImage" class="form-control" :class="{ 'is-invalid': form.errors.has('ProductImage') }">
                                            <div class="error" v-if="form.errors.has('ProductImage')" v-html="form.errors.get('ProductImage')" />
                                            <img v-if="form.ProductImage" :src="showImage(form.ProductImage)" alt="" height="40px" width="40px">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button :disabled="form.busy" type="submit" class="btn btn-primary">{{ editMode ? "Update" : "Create" }} Product</button>
                        </div>
                    </form>
                </div>
            </div>
